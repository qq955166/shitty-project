...
CREATE TABLE restaurant (id INT(11) AUTO_INCREMENT PRIMARY KEY, user_id INT(11), address VARCHAR(50), description VARCHAR(200), lastvistiedday VARCHAR(50), food_type VARCHAR(50));